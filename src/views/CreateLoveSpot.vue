      ...
      <section class="section color-section">
        ...
        <div class="color-palette">
          ...
          <div class="color-options" :class="{ expanded: showAllColors }">
            <button v-for="color in (showAllColors ? COLORS : COLORS.slice(0, 6))" :key="color.name"
          ...
          <button v-if="COLORS.length > 8" @click="showAllColors = !showAllColors" class="expand-btn"
